/**
 * Opens a new window and displays a modal for buying sunglasses.
 */
export const openWin = (
  item: { coast: number; id: Glasses.Item['id'] },
  count = 1,
  ...
  newWindow.document.write(`
    ...
    document.querySelector('.do-not-clear').addEventListener('input', (e) => {
